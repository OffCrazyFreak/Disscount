// Barrel for the single-key ("Disscount_app") localStorage helpers,
// split by domain under ./storage. Import from here to stay path-stable.
export * from "@/utils/browser/storage/core";
