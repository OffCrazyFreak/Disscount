...
The app's own OG and Twitter link-preview images are separate, `src/app/opengraph-image.png` and `twitter-image.png`, picked up automatically by Next.js's file-based metadata.
