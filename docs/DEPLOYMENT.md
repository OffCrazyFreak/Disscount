...
| **pnpm overrides got stripped**                      | `overrides` in `pnpm-workspace.yaml` weren't honored, so a version that has to be forced belongs in `package.json` as a direct dependency instead.                                                                                                                                                                                                                                                                                                                                                                  |
