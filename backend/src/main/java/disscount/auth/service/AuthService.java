package disscount.auth.service;
...
import disscount.auth.dao.RefreshTokenRepository;
import disscount.auth.domain.RefreshToken;
import disscount.auth.dto.*;
...
public class AuthService {
    ...
    disscount.util.PasswordValidator.validateOrThrow(request.getPassword());
